...
export default function HeroBanner({ anime }: Props) {
  ...
  return (
    <div className="relative h-[65vh] min-h-[420px] w-full overflow-hidden">
      ...
      <div className="absolute bottom-20 left-8 max-w-2xl animate-fade-in">
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <Link
            to={`/anime/${anime.id}`}
            className="flex items-center gap-2 rounded-md bg-white/20 px-6 py-2.5 text-sm font-semibold text-white backdrop-blur transition hover:bg-white/30"
          >
            <Info size={16} />
            More info
          </Link>
